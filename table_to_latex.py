...
df['Average Betweenness Centrality (Nodes)'] = df['Average Betweenness Centrality (Nodes)'].round(4)
df['Average Betweenness Centrality (Edges)'] = df['Average Betweenness Centrality (Edges)'].round(4)
df['Normalized Measure of Orientation-Order'] = df['Normalized Measure of Orientation-Order'].round(4)
...
with open('metrics_table1.tex', 'w', encoding='utf8') as f:
    f.write(latex_table)
...
# Save the LaTeX table to a file using utf8 encoding
with open('metrics_table2.tex', 'w', encoding='utf8') as f:
    f.write(latex_table)
