...
df['Average Street Length (m)'] = df['Average Edge Length (m)'].round(2)
df['Average Betweenness Centrality (Nodes)'] = df['Betweenness Centrality (Nodes)'].round(4)
df['Average Betweenness Centrality (Edges)'] = df['Betweenness Centrality (Edges)'].round(4)
